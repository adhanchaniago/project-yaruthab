            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        ...
                        <input type="file" class="dropify" name="gambar" id="gambar-i" data-height="95" data-allowed-file-extensions="jpg jpeg png" data-default-file="<?= base_url('assets'); ?>/img/uploads/profile/<?= $pengurus['img']; ?>" />
                    </div>
                </div>
            </div>
