    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?= base_url('admin') ?>" class="brand-link">
                <img src="<?= base_url('assets') ?>/img/logo1.png" alt="Yaruthab Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">YARUTHAB</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; <a href="<?= base_url('/') ?>">YARUTHAB</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
